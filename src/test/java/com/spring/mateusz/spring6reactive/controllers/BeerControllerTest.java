...
class BeerControllerTest {
    ...
    void testGetByIdNotFound() {
        webTestClient.get().uri(BeerController.BEER_PATH_ID, 1000)
                .exchange()
    ...
    void testUpdateBeerNotFound() {
        webTestClient.put().uri(BeerController.BEER_PATH_ID, 10000)
                .body(Mono.just(BeerRepositoryTest.getTestBeer()), BeerDTO.class)
                .exchange()
                .expectStatus().isNotFound();
    }
    ...
    void testDeleteBeerNotFound() {
        webTestClient.delete().uri(BeerController.BEER_PATH_ID, 1789)
                .exchange()
                .expectStatus().isNotFound();
    }
}